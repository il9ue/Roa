...
function Main(protocols, server, options){
  if (!(this instanceof Main)) 
  	return new Main(server, options);
...
Main.prototype.__proto__ = eventEmitter.prototype;

Main.prototype.OnUrlRequest = function(protocols){
...
**/
Main.prototype.OnUrlParsing = function(host, port){
 ...
 **/
Main.prototype.attach = function(protocols, server, options){
...
Main.prototype.bind = function (agent) {
	this.agent = agent;
